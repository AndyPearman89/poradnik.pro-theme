...
$desc  = 'Praktyczne poradniki krok po kroku, checklisty i gotowe rozwiązania od ekspertów Poradnik.pro.';
$terms = get_terms([
	'taxonomy'   => 'kategoria',
	'hide_empty' => true,
	'number'     => 12,
...
?>
<section class="cpt-archive cpt-archive--poradnik">
	<header class="cpt-archive__hero">
		<div class="cpt-archive__hero-content">
			<span class="cpt-badge">Poradniki</span>
	...
	<nav class="cpt-archive__chips" aria-label="Popularne kategorie poradników">
		...
		<?php while (have_posts()) : the_post(); ?>
			<article <?php post_class('cpt-archive-card'); ?>>
				...
				<div class="cpt-archive-card__body">
					...
					<div class="cpt-archive-card__meta">
					...
					<a class="cpt-btn cpt-btn--outline cpt-btn--sm" href="<?php the_permalink(); ?>">Czytaj poradnik</a>
				</div>
			</article>
		<?php endwhile; ?>
	</div>
	...
	<?php else : ?>
		<div class="cpt-empty-state">
			<h2>Brak poradników do wyświetlenia</h2>
			<p>Sprawdź ponownie za chwilę lub przejdź do strony głównej.</p>
