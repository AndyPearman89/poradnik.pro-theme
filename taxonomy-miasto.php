...
<section class="cpt-archive cpt-taxonomy cpt-taxonomy--miasto">
	<header class="cpt-archive__hero">
		<div class="cpt-archive__hero-content">
			...
			<div class="cpt-taxonomy__stats">
				...
				<div class="cpt-taxonomy__stat"><span class="cpt-taxonomy__stat-value"><?php echo !empty($related_terms) ? esc_html((string) count($related_terms)) : '0'; ?></span><span class="cpt-taxonomy__stat-label">Sąsiednie miasta</span></div>
			</div>
	...
	<nav class="cpt-archive__chips" aria-label="Powiązane miasta">
			...
			<?php while (have_posts()) : the_post(); ?>
				<article <?php post_class('cpt-archive-card'); ?>>
					...
					<div class="cpt-archive-card__body">
						...
						<div class="cpt-archive-card__footer"><a class="cpt-btn cpt-btn--outline cpt-btn--sm" href="<?php the_permalink(); ?>"><?php esc_html_e('Zobacz profil', 'generatepress-child-poradnik'); ?></a></div>
					</div>
				</article>
			<?php endwhile; ?>
		</div>
