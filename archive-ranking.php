...
$desc  = 'Aktualne rankingi produktów i usług z transparentną metodologią oceny.';
$terms = get_terms([
	'taxonomy'   => 'kategoria',
	'hide_empty' => true,
	'number'     => 12,
...
?>
<section class="cpt-archive cpt-archive--ranking">
	<header class="cpt-archive__hero">
		<div class="cpt-archive__hero-content">
			<span class="cpt-badge">Rankingi</span>
	...
	<nav class="cpt-archive__chips" aria-label="Popularne kategorie rankingów">
		...
		<?php while (have_posts()) : the_post(); ?>
			<article <?php post_class('cpt-archive-card'); ?>>
				...
				<div class="cpt-archive-card__body">
					...
					<a class="cpt-btn cpt-btn--outline cpt-btn--sm" href="<?php the_permalink(); ?>">Zobacz ranking</a>
				</div>
			</article>
		<?php endwhile; ?>
	</div>
	...
	<?php else : ?>
		<div class="cpt-empty-state">
			<h2>Brak rankingów do wyświetlenia</h2>
			<p>Opublikujemy kolejne zestawienia wkrótce.</p>
