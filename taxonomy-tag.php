...
$related_terms = $term instanceof WP_Term ? poradnik_get_taxonomy_related_terms($taxonomy, (int) $term->term_id, 10) : [];
$post_type_labels = poradnik_get_archive_post_type_labels();
$post_count = (int) $GLOBALS['wp_query']->found_posts;
?>
<section class="cpt-archive cpt-taxonomy cpt-taxonomy--tag">
	<header class="cpt-archive__hero">
		<div class="cpt-archive__hero-content">
			...
			<div class="cpt-taxonomy__stats">
				...
				<div class="cpt-taxonomy__stat"><span class="cpt-taxonomy__stat-value"><?php echo !empty($related_terms) ? esc_html((string) count($related_terms)) : '0'; ?></span><span class="cpt-taxonomy__stat-label">Powiązane tagi</span></div>
			</div>
	...
	<nav class="cpt-archive__chips" aria-label="Powiązane tagi">
