...
<section class="cpt-archive cpt-taxonomy cpt-taxonomy--usluga">
	<header class="cpt-archive__hero">
		<div class="cpt-archive__hero-content">
			...
			<div class="cpt-taxonomy__stats">
				<div class="cpt-taxonomy__stat"><span class="cpt-taxonomy__stat-value"><?php echo esc_html((string) $post_count); ?></span><span class="cpt-taxonomy__stat-label">Wyników</span></div>
				<div class="cpt-taxonomy__stat"><span class="cpt-taxonomy__stat-value"><?php echo esc_html((string) count($post_type_labels)); ?></span><span class="cpt-taxonomy__stat-label">Formaty treści</span></div>
				<div class="cpt-taxonomy__stat"><span class="cpt-taxonomy__stat-value"><?php echo !empty($related_terms) ? esc_html((string) count($related_terms)) : '0'; ?></span><span class="cpt-taxonomy__stat-label">Powiązane usługi</span></div>
			</div>
	...
	<nav class="cpt-archive__chips" aria-label="Powiązane usługi">
			...
			<?php while (have_posts()) : the_post(); ?>
				<article <?php post_class('cpt-archive-card'); ?>>
					...
					<div class="cpt-archive-card__body">
						...
						<div class="cpt-archive-card__meta"><span><?php echo esc_html(poradnik_get_post_type_label(get_the_ID())); ?></span></div>
						<p class="cpt-archive-card__excerpt"><?php echo esc_html(wp_trim_words(get_the_excerpt(), 24)); ?></p>
						<div class="cpt-archive-card__footer"><a class="cpt-btn cpt-btn--outline cpt-btn--sm" href="<?php the_permalink(); ?>"><?php esc_html_e('Zobacz szczegóły', 'generatepress-child-poradnik'); ?></a></div>
					</div>
				</article>
			<?php endwhile; ?>
		</div>
